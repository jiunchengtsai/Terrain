...
"""autogenerated by genpy from huskyterrain/imutrans.msg. Do not edit."""
import sys
...
class imutrans(genpy.Message):
  _md5sum = "b6ceccfc5eff5b49731f1f199301e128"
  _type = "huskyterrain/imutrans"
...
float64 y
float64 z"""
  __slots__ = ['header','pose','angular_acceleration','coorx','coory','id','sampling_rate']
  _slot_types = ['std_msgs/Header','sensor_msgs/Imu','geometry_msgs/Vector3','float32','float32','int32','int32']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,pose,angular_acceleration,coorx,coory,id,sampling_rate
    ...
    """
    if args or kwds:
      super(imutrans, self).__init__(*args, **kwds)
